...
public class AlgaeAutoPivotDown_cmd extends Command {
  private  Algae tempAlgae;
  private static final double tune_Algae_DownIntakeSpeed = 0.5;
  private static final double tune_Algae_DownEncoderPos = 3.5;

  public AlgaeAutoPivotDown_cmd(Algae ss_Algae) {
    tempAlgae = ss_Algae;
