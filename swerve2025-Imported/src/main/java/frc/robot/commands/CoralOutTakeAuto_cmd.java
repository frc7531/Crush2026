...
public class CoralOutTakeAuto_cmd extends Command {
  /** Creates a new Coral_cmd. */
  private final Coral_SS ss_coral;
  final double tune_coral_topmotorOuttake = 0.3;
  final double tune_coral_bottommotorOuttake = -0.3;

  public CoralOutTakeAuto_cmd(Coral_SS temp_ss_Coral) {
  ...
  @Override
  public void execute() {
    this.ss_coral.TopSpeedAuto(tune_coral_topmotorOuttake);
